...
const handleInputKey = (event) => {
  if (event.key === 'ArrowUp') {
    ...
    if (historyIndex < commandHistory.value.length - 1) {
      historyIndex++
      command.value = commandHistory.value[commandHistory.value.length - 1 - historyIndex]
    }
...
<template>
  <div class="debug" v-if="isActive">
    <div>
      <strong>Dostępne komendy:</strong>
      <ul>
        <li><code><span class="command">/addCards</span> &lt;id | id,id,...&gt;</code></li>
        <li><code><span class="command">/removeCards</span> &lt;id | id,id,...&gt;</code></li>
        <li><code><span class="command">/setGamePhase</span> &lt;phase | last&gt;</code></li>
        <li><code><span class="command">/setAttackingPhase</span> &lt;phase | last&gt;</code></li>
        <li><code><span class="command">/setMarriage</span> &lt;name&gt;</code></li>
        <li><code><span class="command">/debugEstrid</span></code></li>
        <li><code><span class="command">/debugGameEnd</span></code></li>
        <li><code><span class="command">/getProperty </span>&lt;properties&gt;</code></li>
      </ul>
    </div>
